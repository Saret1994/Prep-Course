...
function elevarAlCubo(num) {
  ...
  // Tu código:
  return Math.pow (num, 3); return resultado 
}
...
return "Es vocal"; else if (letra.length > 1 || letra.length < 1) return "Dato incorrecto"; else return "Dato incorrecto"}
